...
namespace AliyunDns.Core.Beans.Aliyun
{
    ...
    [JsonSourceGenerationOptions(WriteIndented = true)]
    [JsonSerializable(typeof(QueryRecordResponse))]
    [JsonSerializable(typeof(IEnumerable<QueryRecordResponse>))]
    public partial class QueryRecordResponseSerializerContext : JsonSerializerContext
    {
    }    
}
